...
export const agentAlerts = [
  ...
  { agent: 'Order Bank Agent', module: 'Order Bank', status: 'ALERT', lastRun: '8 minutes ago', alert: 'FG-T800-CL Class 8 Highway Tractor — 3 work orders at risk of missing promise date due to CMP-WHL-DRV shortage. WO-4421, WO-4424, WO-4428 all require drive axle wheel assemblies within next 4 days.', severity: 'HIGH', affectedSKU: 'FG-T800-CL' },
